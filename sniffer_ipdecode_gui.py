...
config_col = [
    [
        ...
        sg.In(size=(25, 1), enable_events=True, key="-HOST-", default_text='192.168.0.7'),
    ...
    if event == "Capture":
        ...
        try:
            ...
            while counter < 10:
                ...
                valores.append([ip_header.protocol,ip_header.src_address,ip_header.dst_address])

                window['-FLIST-'].Update(values=valores)
                counter += 1
